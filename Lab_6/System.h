...
#define GPIOC_CRL (*(uint32_t volatile *) (GPIOC_BASE + 0x00))
#define GPIOC_CRH (*(uint32_t volatile *) (GPIOC_BASE + 0x04))
#define GPIOC_ODR (*(uint32_t volatile *) (GPIOC_BASE + 0x0C))	
#define GPIOC_BSRR (*(uint32_t volatile *) (GPIOC_BASE + 0x10))
#define GPIOC_BRR (*(uint32_t volatile *) (GPIOC_BASE + 0x14))
...
#define RCC_APB2RSTR (*(uint32_t volatile *) (RCC_BASE + 0x0C))
#define RCC_APB1RSTR (*(uint32_t volatile *) (RCC_BASE + 0x10))
...
#define FLASH_ACR (*(uint32_t volatile *) (0x40022000))
...
#define ADC1_SR (*(uint32_t volatile *) (ADC1_BASE + 0x00))
#define ADC1_CR1 (*(uint32_t volatile *) (ADC1_BASE + 0x04))
#define ADC1_CR2 (*(uint32_t volatile *) (ADC1_BASE + 0x08))
#define ADC1_SMPR1 (*(uint32_t volatile *) (ADC1_BASE + 0x0C))
#define ADC1_SMPR2 (*(uint32_t volatile *) (ADC1_BASE + 0x10))
#define ADC1_SQR1 (*(uint32_t volatile *) (ADC1_BASE + 0x2C))
#define ADC1_SQR2 (*(uint32_t volatile *) (ADC1_BASE + 0x30))
#define ADC1_SQR3 (*(uint32_t volatile *) (ADC1_BASE + 0x34))	
#define ADC1_DR (*(uint32_t volatile *) (ADC1_BASE + 0x4C))	
